...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    @Override
    public ResponseRestaurantDto createRestaurant(ResponseRestaurantDto restaurantDto) {
    ...
    @Override
    public ResponseRestaurantDto changeCred(Long id, ChangeRestaurantCred changeRequest) {
    ...
    @Override
    public ResponseRestaurantDto updateRestaurant(Long id, ResponseRestaurantDto restaurantDto) {
        return restaurantRepository.findById(id).map(restaurant -> {
